...
Consulted with: None
   ...
   Builds expression tree; # means evaluate the top item
...
class BinOpExpr(Expr):
    ...
    def __str__(self):
        ...
        return "({}{}{})".format(self.left, self.opsym, self.right)
            ...
            for token in line.strip().split():
                ...
                if token == "#" : 
                    ...
                    if isinstance(var, VarExpr) and isinstance(val, ConstExpr):
                        ...
                        ## Why?  Because imagine if we did
                        ## 7 x + x = #
                        ##   we would get an infinite recursion in 'eval'
                else: 
                    ### Anything else?  
